...
$wp_customize->add_section(
	'section_blog',
	array(
		'title'    => esc_html__( 'Blog/Archive', 'blog-up' ),
		'priority' => 100,
...
$wp_customize->add_control(
	new Switcher(
		...
		'theme_options[show_excerpt]',
		array(
			'label'    => esc_html__( 'Show Excerpt', 'blog-up' ),
			'section'  => 'section_blog',
			'priority' => 100,
		)
	)
...
$wp_customize->add_control(
	new Number(
		...
		'theme_options[excerpt_length]',
		array(
			'label'             => esc_html__( 'Excerpt Length', 'blog-up' ),
			'section'           => 'section_blog',
			'priority'          => 100,
			'input_attrs'       => array(
				'min'   => 1,
...
$wp_customize->add_control(
	new Text(
		...
		'theme_options[readmore_text]',
		array(
			'label'             => esc_html__( 'Read More Text', 'blog-up' ),
			'section'           => 'section_blog',
			'priority'          => 100,
			'active_callback'   => array( Callback::class, 'active' ),
			'conditional_logic' => array(
