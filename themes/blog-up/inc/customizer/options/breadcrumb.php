...
$wp_customize->add_section(
	'section_breadcrumb',
	array(
		'title'    => esc_html__( 'Breadcrumb', 'blog-up' ),
		'priority' => 100,
...
$wp_customize->add_control(
	new Switcher(
		...
		'theme_options[enable_breadcrumb]',
		array(
			'label'    => esc_html__( 'Enable Breadcrumb', 'blog-up' ),
...
$wp_customize->add_control(
	new Radio(
		...
		'theme_options[breadcrumb_type]',
		array(
			'label'             => esc_html__( 'Breadcrumb Type', 'blog-up' ),
			'section'           => 'section_breadcrumb',
			'priority'          => 100,
			'choices'           => array(
				'rankmath' => esc_html__( 'Rank Math', 'blog-up' ),
				'yoast'    => esc_html__( 'Yoast SEO', 'blog-up' ),
			),
